...
def plot_cpu_gpu_time(csv_files):
    ...
    for category, cpu_cols, gpu_cols, cpu_perc, gpu_perc in [
        ...
        plt.savefig(f'{category}_{last_part}.png')
...
def read_csv_files_in_directory(directory):
    ...
    for csv_file in csv_files:
        ...
        if ('nosplit' in csv_file and 'jobs' not in csv_file) or \
            ('data' in csv_file and 'jobs' not in csv_file):
...
# csv_file = '/home/crownlabs/Plebiscitotest/1tstconskipdeconfilctions_UTIL_FIFO_0_nosplit.csv'


directory_path = '/home/crownlabs/Plebiscitotest/cluster-trace-gpu-v2020/simulator'
...
# csv_file = '/home/crownlabs/Plebiscitotest/cluster-trace-gpu-v2020/simulator/res/data_FIFO_ID.csv'
# plot_cpu_gpu_time(csvs)

directory_path = '/home/crownlabs/Plebiscitotest/res'
csvs = read_csv_files_in_directory(directory_path)
for c in csvs:
    plot_cpu_gpu_time([c])
